...
- [ ] ~~T023~~ [P] [US1] ~~Unit test at `tests/install/unit/test_plan_snapshot_digests.py`: PlanSnapshot seals deterministic digests…~~ **Retired by the trust-git amendment (2026-09-01)** together with T012. No PlanSnapshot to test.
