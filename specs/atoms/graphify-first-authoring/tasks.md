...
- [X] T008 [US1] Manually verify via [quickstart.md](quickstart.md) steps 3–5 (adopt in `.haex-hive.json`, `haex constitution assemble`, `haex constitution show`) that an agent follows the contributed authoring behavior — this is an agent-behavior check, not a unit test. T024/T025 verify assembly and source attribution only; they do not satisfy this task.
