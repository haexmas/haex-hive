...
└── haex_hive/
    ...
    │   ├── safety.py                  # Principle-I secret + Principle-VIII candidate validation
...
│   ├── test_assemble_multi_source.py  # US3, including complete framed stdio confirmation
│   └── test_show.py                   # US4
└── unit/                              # per-module unit tests
    ...
    ├── test_transform.py              # migration table rules and FR-038 original/sidecar secret refusal/invalidation
