...
- [x] Eight new diagnostic keys enumerated in FR-001..FR-004
- [x] Each admitted kind defines a closed delivers-category allowlist and dispatch contract
...
- The simplified spec has 10 FRs, 4 user stories (US1 MVP + US2/US3/US4 P2/P3), 6 SCs, 8 new diagnostic keys, and 2 initially admitted kinds. Roughly the same shape as prior versions but with a materially different mechanism.
