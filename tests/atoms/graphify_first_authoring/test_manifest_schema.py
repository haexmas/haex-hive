...
_ATOM_DIR = _REPO_ROOT / ".specify" / "atoms" / "graphify-first-authoring"
_ATOM_MANIFEST = _ATOM_DIR / "manifest.json"
_SCHEMA = (
    _REPO_ROOT
    / "specs"
...
def test_manifest_conforms_to_v2_schema() -> None:
    ...
    manifest = _load_json(_ATOM_MANIFEST)
...
def test_contributed_constitution_file_exists() -> None:
    ...
    assert (_ATOM_MANIFEST.parent / rel).is_file()
